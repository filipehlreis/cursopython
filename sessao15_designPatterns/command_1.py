"""
Command tem intencao de encapsular uma solicitacao como um objeto, desta forma,
permitindo parametrizar clientes com diferentes solicitacoes, enfileirar ou
fazer registros (log) de solicitacoes e suportar operacoes que podem ser
desfeitas.

É formado por um cliente (quem orquestra tudo), um invoker (que invoca as
solicitacoes), um ou varios objetos de comando (que fazem a ligacao entre o
receiver e a acao a ser executada) e um receiver (o objeto que vai executar
a acao no final)
"""
...
if __name__ == "__main__":
    ...
    remote.button_add_command('thirth_button', bedroom_light_blue)
    ...
    remote.button_pressed('thirth_button')
    # remote.button_undo('thirth_button')
