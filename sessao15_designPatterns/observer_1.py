"""
O padrao Observer tem a intencao de definir uma dependencia de um-para-muitos
entre objetos, de maneira que quando um objeto muda de estado, todo os seus
dependetes sao notificados e atualizados automaticamente.

Um Observer é um objeto que gostaria de ser informado, um observable (subject)
é a entidade que gera as informacoes.
"""
