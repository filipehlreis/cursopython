"""
Adapter é um padrao de projeto estrutural que tem a intencao de permitir que
duas classes que seriam incompativeis trtabalhem em conjunto atraves de um
"adaptador".
