"""
Façade (Fachada) é um padrao de projeto estrutural que tem a intencao de
fornecer uma interface unificada para um conjunto de interfaces em um
subsistema. Façade define uma interface de nivel mais alto que torna o
subsistema mais facil de ser usado.
