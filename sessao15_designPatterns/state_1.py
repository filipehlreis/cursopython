"""
O Padrao de projeto State é um padrao comportamental que tem a intencao de
permitir a um objeto mudar seu comportamento quando o seu estado interno
muda.
...
class PaymentRejected(OrderState):
    ...
    def approve(self) -> None:
        print("Pagamento recusado. Nao vou mover para aprovado.")
