"""
Builder é um padrao de criacao que tem a intencao de separar a construcao de um
objeto complexo da sua representacao, de modo que o mesmo processo de
construcao possa criar diferentes representacoes.

Builder te da a possibilidade de criar objetos passo-a-passo e isso já é
possivel no python sem este padrao.
