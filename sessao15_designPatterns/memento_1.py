"""
GoF - Memento é um padrao de projeto comportamental que tem a intencao de
permitir que voce salve e restaure um estado anterior de um objeto originator
sem revelar os detalhes da sua implementacao e sem violar o encapsulamento.

Originator é o objeto que deseja salvar se estado.
Memento é usado para salvar o estado do Originator.
Caretaker é usado para armazenar mementos.
Caretaker tambem é usado como Padrao Command.
"""
